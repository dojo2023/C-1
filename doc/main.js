 ...
 */
    ...
    //weatherコードに応じた天気(背景)
	    let weather_image ="";
		weather_image += weather_select_image(json,now); 	//下の方でweather_selectメソッドを定義してる
  		document.getElementById('today_weather_image').innerHTML = weather_image;
	  });
...
//天気画像背景
	function weather_select_image(json,day){
	    ...
	    else if(json.daily.weathercode[day] == 3){ return  "&#x2601"; }
	    else if(json.daily.weathercode[day] <= 49 && json.daily.weathercode[day] >=4){ return "&#x1f32b"; }
	    else if(json.daily.weathercode[day] <= 59 && json.daily.weathercode[day] >=50){ return "&#x1f327"; }
